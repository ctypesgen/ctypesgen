...
"""
    ...
    def test_macro_math_multiplier_json(self):
        ...
        self.assertEqual(json('multipler_macro'),
            {"args": ["x", "y"],
             "body": "(x * y)",
    ...
    def test_macro_math_minus_json(self):
        ...
        self.assertEqual(json('minus_macro'),
            {"args": ["x", "y"],
             "body": "(x - y)",
             "name": "minus_macro",
             "type": "macro_function"})
    ...
    def test_macro_math_divide_json(self):
        ...
        self.assertEqual(json('divide_macro'),
            {"args": ["x", "y"],
             "body": "(x / y)",
             "name": "divide_macro",
             "type": "macro_function"})
    ...
    def test_macro_math_mod_json(self):
        ...
        self.assertEqual(json('mod_macro'),
            {"args": ["x", "y"],
             "body": "(x % y)",
             "name": "mod_macro",
             "type": "macro_function"})
    ...
    def test_macro_subcall_simple_json(self):
        ...
        self.assertEqual(json('subcall_macro_simple'),
            {"args": ["x"],
             "body": "A",
    ...
    def test_macro_subcall_simple_plus_json(self):
        ...
        self.assertEqual(json('subcall_macro_simple_plus'),
            {"args": ["x"],
             "body": "(A + x)",
    ...
    def test_macro_subcall_minus_json(self):
        ...
        self.assertEqual(json('subcall_macro_minus'),
            {"args": ["x", "y"],
    ...
    def test_macro_subcall_minus_plus_json(self):
        ...
        self.assertEqual(json('subcall_macro_minus_plus'),
            {"args": ["x", "y", "z"],
                     ...
                     'enumerators': [
                        ['TEST_1',
                         {'Klass': 'ConstantExpressionNode',
                          'errors': [],
                          'value': 0}],
                        ['TEST_2', {'Klass': 'BinaryExpressionNode',
                                     'can_be_ctype': [False, False],
                                     'errors': [],
                                     'format': '(%s + %s)',
                                     'left': {
