...
def fix_conflicting_names(data, opts):
    ...
    preamble_names = preamble_names.union(['DarwinLibraryLoader',
                                           'LibraryLoader', 'LinuxLibraryLoader',
                                           'WindowsLibraryLoader',
                                           '_WindowsLibrary', 'add_library_search_dirs',
                                           '_environ_path', 'ctypes',
                                           'load_library', 'loader', 'os', 're', 'sys'])
    preamble_names = preamble_names.union(['ArgumentError', 'CFUNCTYPE',
                                           'POINTER', 'ReturnString', 'String', 'Structure',
                                           'UNCHECKED', 'Union',
                                           'UserString', '_variadic_function', 'addressof',
                                           'c_buffer', 'c_byte',
                                           'c_char', 'c_char_p', 'c_double', 'c_float', 'c_int',
                                           'c_int16',
                                           'c_int32', 'c_int64', 'c_int8', 'c_long', 'c_longlong',
                                           'c_ptrdiff_t',
                                           'c_short', 'c_size_t', 'c_ubyte', 'c_uint', 'c_uint16',
                                           'c_uint32',
                                           'c_uint64', 'c_uint8', 'c_ulong', 'c_ulonglong',
                                           'c_ushort', 'c_void',
