...
_lr_action_items = {
    ...
    "PP_IDENTIFIER_PASTE": ([310, 100, 103, 156, 315], [207, 207, 210, 210, 207]),
    "PP_DEFINE_NAME": ([11], [48]),
    "FLOAT": (
        [
            13,
            357,
...
_lr_goto_items = {
    "expression_statement": (
        [395, 264, 347, 343, 409, 381, 258, 141, 148, 407, 379, 61, 159, 241, 383, 268],
        [136, 136, 136, 378, 136, 136, 343, 136, 136, 136, 136, 136, 136, 136, 136, 136],
    ),
    "storage_class_specifier": (
        [29, 141, 28, 222, 55, 60, 61, 232, 65, 2, 3, 328, 1, 238, 168],
        [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
    ),
    "str_opt_expr_pair": ([422, 412, 413, 390], [404, 418, 404, 404]),
    "constant": (
        [
            191,
            152,
    ...
    "identifier_list": ([55], [129]),
    "define": ([1], [23]),
    "initializer": ([385, 277, 167], [401, 352, 275]),
    "macro_param": (
        [
            329,
            225,
    ...
    "struct_declaration_list": ([173, 67, 169], [287, 170, 279]),
    "macro_parameter_list": ([71], [176]),
    "enumerator": ([54, 119, 230], [120, 120, 335]),
    "declaration_list": ([61, 28, 65], [141, 60, 168]),
    "iteration_statement": (
        [148, 264, 407, 395, 383, 61, 159, 241, 379, 381, 347, 141, 268, 409],
    ...
    "compound_statement": (
        [60, 264, 409, 383, 159, 268, 241, 65, 347, 141, 61, 381, 407, 148, 379, 168, 28, 395],
        [134, 144, 144, 144, 144, 144, 144, 166, 144, 144, 144, 144, 144, 144, 144, 278, 57, 144],
    ),
    ...
    "pointer": (
        [58, 44, 165, 17, 232, 358, 7, 172, 30, 128, 115, 1, 222],
        [14, 70, 14, 14, 235, 14, 46, 14, 14, 235, 226, 14, 226],
    ),
    "selection_statement": (
        [407, 141, 61, 347, 159, 268, 148, 241, 264, 409, 395, 379, 381, 383],
    ...
    "declaration_impl": ([28, 168, 65, 61, 141, 1, 60], [20, 20, 20, 20, 20, 20, 20]),
    "and_expression": (
        [
            370,
            167,
    ...
    "type_name": ([73, 48, 138, 187], [179, 89, 179, 295]),
    ...
    "statement": (
        [264, 407, 381, 347, 379, 148, 409, 159, 241, 395, 61, 141, 268, 383],
        [345, 414, 398, 380, 397, 260, 416, 272, 260, 406, 154, 154, 349, 400],
    ),
    "cast_expression": (
        [
            395,
    ...
    "init_declarator": ([58, 165, 30], [63, 274, 63]),
    "struct_declarator_list": ([172], [286]),
    ...
    "type_qualifier_list": ([7], [44]),
    "struct_declaration": ([279, 169, 67, 287, 173, 170], [280, 171, 171, 280, 171, 280]),
    "string_literal": (
        [
            203,
            148,
    ...
    "parameter_type_list": ([222, 232, 328, 55], [326, 326, 374, 126]),
    "parameter_declaration": ([328, 232, 238, 55, 222], [127, 127, 338, 127, 127]),
    ...
    "declarator": (
        [232, 165, 1, 30, 128, 58, 172, 17, 358],
        [51, 133, 28, 65, 234, 133, 283, 51, 283],
    ),
    "argument_expression_list": ([216], [321]),
    "str_opt_expr_pair_list": ([390, 413, 422], [405, 419, 423]),
    "statement_list": ([61, 141], [148, 241]),
    "constant_expression": (
        [48, 290, 56, 175, 225, 285, 152, 329, 355, 229],
        [99, 362, 132, 289, 330, 356, 266, 376, 386, 334],
    ),
    "enumerator_list_iso": ([54, 119], [123, 123]),
    "primary_expression": (
        [
            385,
            73,
    ...
    "declaration_specifiers": (
        [29, 222, 238, 232, 28, 168, 328, 60, 1, 61, 141, 55, 65, 3, 2],
        [62, 128, 128, 128, 58, 58, 128, 58, 30, 58, 58, 128, 58, 43, 42],
    ),
    "declaration": ([141, 60, 1, 168, 65, 28, 61], [135, 135, 31, 135, 59, 59, 59]),
    "direct_declarator": (
        [172, 1, 128, 235, 14, 30, 358, 232, 58, 17, 165],
        [27, 27, 27, 50, 50, 27, 27, 27, 27, 27, 27],
    ),
    ...
    "init_declarator_list": ([58, 30], [64, 64]),
    "shift_expression": (
        [
            208,
            229,
    ...
    "jump_statement": (
        [264, 159, 381, 379, 347, 407, 141, 268, 241, 148, 61, 395, 383, 409],
        [155, 155, 155, 155, 155, 155, 155, 155, 155, 155, 155, 155, 155, 155],
    ),
    "struct_declarator": ([358, 172], [387, 282]),
    "function_definition": ([1], [33]),
    "parameter_list": ([328, 222, 55, 232], [130, 130, 130, 130]),
    "enum_specifier": (
        [
            82,
            170,
    ...
    "enumerator_list": ([119, 54], [227, 121]),
    "labeled_statement": (
        [141, 148, 395, 407, 61, 383, 379, 159, 268, 241, 347, 264, 409, 381],
        [140, 140, 140, 140, 140, 140, 140, 140, 140, 140, 140, 140, 140, 140],
    ),
    "abstract_declarator": ([115, 222, 232, 128], [223, 327, 327, 233]),
    "specifier_qualifier_list": (
        [169, 170, 173, 48, 279, 73, 187, 138, 287, 88, 82, 67],
        [172, 172, 172, 115, 172, 115, 115, 115, 172, 196, 188, 172],
    ),
    ...
    "assignment_operator": ([143], [257]),
    "initializer_list": ([277], [353]),
    ...
    "direct_abstract_declarator": ([115, 235, 226, 128, 232, 222], [224, 332, 332, 224, 224, 224]),
    "identifier": (
        [
            205,
            410,
